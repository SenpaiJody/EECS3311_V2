...
public class FoodGroupPercentagePieCFGAdvisedGraphRequest extends AdvisedGraphRequest {

	public FoodGroupPercentagePieCFGAdvisedGraphRequest(Filter filter, NutritionGoal goal) {
		super(filter, goal);
	}
