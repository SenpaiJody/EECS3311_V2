...
public class NutrientByDateLineAdvisedGraphRequest extends AdvisedGraphRequest {

	public NutrientByDateLineAdvisedGraphRequest(Filter filter, NutritionGoal goal) {
		super(filter, goal);
	}
